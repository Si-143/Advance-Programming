 ...
 * @version 2.0
 */
    public class DialPanelHalf extends JPanel {

    private DialDrawPanelHalf dial;  // the dial itself
    private JLabel lblTitle; // the label which always appears above the dial

    /**
     * Default constructor
     */
    public DialPanelHalf() {
        ...
        dial = new DialDrawPanelHalf();
        add(dial, BorderLayout.CENTER);

    }
    public DialDrawPanelHalf getDial() {
   return dial;
    }
