 ...
 * @version 2.0
 */
public class BarDrawPanel extends JPanel implements SetValue {
     ...
     */
    public BarDrawPanel(int height, int length, int padding, int barMaxValue, int value) {
    ...
    public void paintComponent(Graphics g) {
        ...
        GradientPaint redtoyellow = new GradientPaint(0 + (float) barx.getHeight() * 1.0F, 0, Color.RED, (float) barx.getHeight() * 0.3F, 0, Color.YELLOW);
        ...
        Line2D valueIndicator = new Line2D.Double(padding / 2F,
                                                  padding + barHeight - (barHeight * value /barMaxValue), 
                                                  barLength + padding * 1.5,
                                                  padding + barHeight - (barHeight * value /barMaxValue));
