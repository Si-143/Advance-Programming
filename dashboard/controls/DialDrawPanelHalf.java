 ...
 * @version 2.0
 */
public class DialDrawPanelHalf extends JPanel implements SetValue {
     ...
     */
    public DialDrawPanelHalf(int radius, int padding, int dialMaxValue, int value) {
